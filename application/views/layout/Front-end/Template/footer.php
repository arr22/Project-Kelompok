  ...
  <footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45 mt-5">
    <div class="flex-w p-b-90">
      <div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
        ...
        <div>
          <p class="s-text7 w-size27">
            Ada Pertanyaan? kirim kami pesan agar kami tau apa yang kurang dari kami: anggarr@gmail.com
          </p>
      ...
      <div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
        ...
        <ul>
          <li class="p-b-9">
            <a href="<?= base_url('HalUtama/daftar_Gunung')?>#" class="s-text7">
              Open Trip
            </a>
          </li>
      ...
      <div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
        ...
        <ul>
          <li class="p-b-9">
            <a href="<?= base_url('HalUtama/daftar_Guide')?>#" class="s-text7">
            Guide 
            </a>
          </li>
    ...
    <div class="t-center s-text8 p-t-20">
      Copyright © 2020 All rights reserved. | This aplication <i class="fa fa-heart-o" aria-hidden="true"></i> by <a
        href="<?= base_url('assets/Template/view_Front-end/')?>https://colorlib.com" target="_blank">Arr</a>
    </div>
    </div>
  </footer>
