  ...
  public function dashboardAdmin()
  {
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'arr.store208@gmail.com',    // Ganti dengan email gmail kamu
            'smtp_pass' => '221200Angga',      // Password gmail kamu
            'smtp_port' => 465,
            'crlf'      => "\r\n",
            'newline'   => "\r\n"
        ];
        ...
        $ci->email->from('no-reply@arr.store.com', 'arr.store.com | arr.store');
        // Email penerima
        $email = $this->input->post('arr.store208@gmail.com');
